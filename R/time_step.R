...
#'
#' @usage time_step(input, start = '2012-05-28 00:00',
...
#'
#' @examples
#' input   <-is.trex(example.data(type="doy", species="PCAB"),
#' tz="GMT",time.format="%H:%M", solar.time=TRUE,
#' long.deg=7.7459,ref.add=FALSE)
#' in.ts   <-time_step(input=input,start='2012-06-28 00:00',end='2012-07-28 00:00',
